...
class ATL_NO_VTABLE NCSiTstSampleInterface : public CComObjectRootEx<CComSingleThreadModel>,
                                             public CComCoClass<NCSiTstSampleInterface, &CLSID_SampleInterfaceTest6>,
                                             public INCCommonInterface,
                                             public INECAdinsExperimentNotifyInterface,
                                             public INECAdinsSiSampleInterface6
{
public:
...
BEGIN_COM_MAP(NCSiTstSampleInterface)
    ...
    COM_INTERFACE_ENTRY(INECAdinsSiSampleInterface6)
END_COM_MAP()


BEGIN_CATEGORY_MAP(NCSiTstSampleInterface)
   IMPLEMENTED_CATEGORY(CATID_VtsAddinsSampleInterface6)
END_CATEGORY_MAP()
    ...
    virtual HRESULT STDMETHODCALLTYPE ProcessSample     (const NECAdinsIdtSiSampleInfo2* pSample, long nSamplesTrackSet, const NECAdinsIdtSiSampleTrackSet3* pSamplesTrackSet, long nSamplesTrack, const NECAdinsIdtSiSampleTrack6* pSamplesTrack) override;
};


OBJECT_ENTRY_AUTO(__uuidof(SampleInterfaceTest6), NCSiTstSampleInterface)
