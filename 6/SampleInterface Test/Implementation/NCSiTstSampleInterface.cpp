...
{
    *pClassID = CLSID_SampleInterfaceTest6;
...
//----------------------------------------------------------------------------
HRESULT NCSiTstSampleInterface::ProcessSample(const NECAdinsIdtSiSampleInfo2* pSample, long nSamplesTrackSet, const NECAdinsIdtSiSampleTrackSet3* pSamplesTrackSet, long nSamplesTrack, const NECAdinsIdtSiSampleTrack6* pSamplesTrack)
{
